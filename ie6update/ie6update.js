...
jQuery(document).ready(function($) {
  $('<div></div>').html(IE6UPDATE_OPTIONS.message || 'U heeft een sterk verouderde browser. Deze pagina is gemaakt voor Internet Explorer 7 en hoger. Download de benodigde updates zo snel mogelijk!')
